            ...
            <div class="card-header">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                    ...
                    <div class="ms-md-auto py-2 py-md-0">
                        <router-link v-if="can('joblist.store')" to="/admin/jobcategory/createjob"
                                     class="btn btn-primary btn-round"><i class="fas fa-plus"></i>Add
                        </router-link>
                    </div>
                </div>
            </div>
            ...
            <FormModal class="form-modal" @submit="submitFromData(fromData)">
                <div class="row">
                    <div class="mb-3">
                        ...
                        <select v-model="fromData.category_id" v-validate="'required'" name="category_id"
                                class="form-control">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" v-validate="'required'" v-model="fromData.position"
                               name="title">
                    </div>

                    <div class="mb-3">
                        <label class="form-label">Salary</label>
                        <input type="number" class="form-control" v-validate="'required'" v-model="fromData.salary"
                               name="salary">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Vacancy</label>
                        <input type="number" class="form-control" v-validate="'required'" v-model="fromData.vacancy"
                               name="title">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Company Name</label>
                        <select v-model="fromData.company_id" v-validate="'required'" name="company_id"
                                class="form-control">
                    ...
                    <div class="mb-3">
                        ...
                        <select v-model="fromData.job_type" v-validate="'required'" name="job_type"
                                class="form-control">
                    ...
                    <div class="mb-3">
                        ...
                        <div>
                            <date-picker class="w-100" placeholder="" v-validate="'required'"
                                         v-model="fromData.date_time" name="date_time" valueType="format"></date-picker>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input @change="uploadImage($event, fromData, 'image')" type="file" name="image"
                                       id="imageField" class="file_field">
                            </div>
                        </div>
                    </div>
